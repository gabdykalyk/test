const svg=new Vivus("back",{type:"delayed",duration:400});function formValidation(){let t=document.querySelector("#formEmail"),e=document.querySelector(".error-msg"),r=document.querySelector("#formPassword");t.addEventListener("input",()=>{t.validity.valid||t.classList.add("error"),t.validity.valid&&t.classList.remove("error")}),r.addEventListener("input",()=>{r.validity.valid||(r.classList.add("error"),e.style.opacity="1"),r.validity.valid&&(r.classList.remove("error"),e.style.opacity="0")})}function registered(){let t=document.querySelector("#completeBtn"),e=document.querySelector("#formContainer"),r=document.querySelector("#registered");t.addEventListener("click",t=>{t.preventDefault(),e.style.display="none",r.style.display="block"})}function btnError(){let t=document.querySelector("#completeBtn");t.addEventListener("click",e=>{e.preventDefault(),t.classList.toggle("btn-error")})}formValidation(),registered(),
/**
